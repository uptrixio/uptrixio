document.addEventListener('DOMContentLoaded', function() {
    ...
    deleteForms.forEach(form => {
        form.addEventListener('submit', function(event) {
             const confirmed = confirm('Are you sure you want to delete this post? There is no way to undo this action.');
            if (!confirmed) {
    ...
    console.log("uptrix.io JS loaded! Like system initialized.");})